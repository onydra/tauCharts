...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("d3-format"), require("taucharts"));
	else if(typeof define === 'function' && define.amd)
		define(["d3-format", ], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("d3-format"), require("taucharts")) : factory(root["d3"], root["Taucharts"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(window, function(__WEBPACK_EXTERNAL_MODULE_d3_format__, __WEBPACK_EXTERNAL_MODULE_taucharts__) {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./plugins/legend.js");
/******/ })
/************************************************************************/
/******/ ({
...
var xml = taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.utils.xml;
...
var d3Format3S = d3_format__WEBPACK_IMPORTED_MODULE_1__["format"]('.3s');
...
taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.plugins.add('legend', ChartLegend);
