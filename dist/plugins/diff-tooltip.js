...
/******/ 	return __webpack_require__(__webpack_require__.s = "./plugins/diff-tooltip.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./plugins/diff-tooltip.ts":
/*!*********************************!*\
  !*** ./plugins/diff-tooltip.ts ***!
  \*********************************/
...
/* harmony import */ var _diff_tooltip_diff_template__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./diff-tooltip/diff-template */ "./plugins/diff-tooltip/diff-template.ts");
/* harmony import */ var _diff_tooltip_interval_highlight__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./diff-tooltip/interval-highlight */ "./plugins/diff-tooltip/interval-highlight.ts");
...
var DiffTooltip = /** @class */ (function (_super) {
    ...
    DiffTooltip.prototype._getTemplate = function () {
        var defaultTemplate = Object(_diff_tooltip_diff_template__WEBPACK_IMPORTED_MODULE_2__["default"])(this, this.settings);
        ...
        return function () {
            ...
            var units = chart.select(function (u) {
                return ((u.config.namespace === 'chart') &&
                    ...
                    (u.config.type !== _diff_tooltip_interval_highlight__WEBPACK_IMPORTED_MODULE_3__["ELEMENT_HIGHLIGHT"]));
            });
            var highlights = chart.select(function (u) { return u.config.type === _diff_tooltip_interval_highlight__WEBPACK_IMPORTED_MODULE_3__["ELEMENT_HIGHLIGHT"]; });
    ...
    DiffTooltip.prototype._getSpecReadyHandler = function () {
        return function (chart, specRef) {
            ...
            chart.traverseSpec(specRef, function (unit, parentUnit) {
                ...
                over.type = _diff_tooltip_interval_highlight__WEBPACK_IMPORTED_MODULE_3__["ELEMENT_HIGHLIGHT"];
    ...
    DiffTooltip.prototype._getGroupedData = function (data, unit) {
        ...
        if (xPeriod) {
            ...
            var periods = taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.tickPeriod
    ...
    return DiffTooltip;
}(_tooltip_tooltip_base__WEBPACK_IMPORTED_MODULE_1__["default"]));
function DiffTooltipPlugin(settings) {
    return new DiffTooltip(settings);
}
taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.unitsRegistry.reg(_diff_tooltip_interval_highlight__WEBPACK_IMPORTED_MODULE_3__["ELEMENT_HIGHLIGHT"], _diff_tooltip_interval_highlight__WEBPACK_IMPORTED_MODULE_3__["default"], 'ELEMENT.GENERIC.CARTESIAN');
taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.plugins.add('diff-tooltip', DiffTooltipPlugin);
/* harmony default export */ __webpack_exports__["default"] = (DiffTooltipPlugin);


/***/ }),

/***/ "./plugins/diff-tooltip/diff-template.ts":
/*!***********************************************!*\
  !*** ./plugins/diff-tooltip/diff-template.ts ***!
  \***********************************************/
/*! exports provided: DIFF_TOOLTIP_CLS, ROW_CLS, HEADER_CLS, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DIFF_TOOLTIP_CLS", function() { return DIFF_TOOLTIP_CLS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ROW_CLS", function() { return ROW_CLS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HEADER_CLS", function() { return HEADER_CLS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DiffTemplate; });
/* harmony import */ var _tooltip_fields_template__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tooltip/fields-template */ "./plugins/tooltip/fields-template.ts");
...
function DiffTemplate(tooltip, settings) {
    var base = Object(_tooltip_fields_template__WEBPACK_IMPORTED_MODULE_0__["default"])(tooltip, settings);
    return Object.assign({}, base, {
        ...
        itemTemplate: function (_a) {
            ...
            return [
                "<div class=\"" + _tooltip_fields_template__WEBPACK_IMPORTED_MODULE_0__["TOOLTIP_CLS"] + "__list__item\">",
                "  <div class=\"" + _tooltip_fields_template__WEBPACK_IMPORTED_MODULE_0__["TOOLTIP_CLS"] + "__list__elem\">" + label + "</div>",
                "  " + valueElement,
                '</div>'
            ].join('\n');
        },
...
/***/ "./plugins/diff-tooltip/interval-highlight.ts":
/*!****************************************************!*\
  !*** ./plugins/diff-tooltip/interval-highlight.ts ***!
  \****************************************************/
/*! exports provided: ELEMENT_HIGHLIGHT, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ELEMENT_HIGHLIGHT", function() { return ELEMENT_HIGHLIGHT; });
/* harmony import */ var taucharts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! taucharts */ "taucharts");
/* harmony import */ var taucharts__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(taucharts__WEBPACK_IMPORTED_MODULE_0__);
...
var IntervalHighlight = {
    ...
    _drawRange: function (range) {
        ...
        function defineGradient() {
            ...
            var defs = d3_selection__WEBPACK_IMPORTED_MODULE_1__["select"](svg)
                .selectAll("#" + id)
                .data(range ? [1] : []);
            defs.exit().remove();
...
/* harmony default export */ __webpack_exports__["default"] = (IntervalHighlight);
