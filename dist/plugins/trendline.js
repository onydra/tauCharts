...
/******/ 	return __webpack_require__(__webpack_require__.s = "./plugins/trendline.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./plugins/trendline.js":
/*!******************************!*\
  !*** ./plugins/trendline.js ***!
  \******************************/
...
function trendline(xSettings) {
    ...
    return {
        ...
        onSpecReady: function (chart, specRef) {
            ...
            var periodGenerator = taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.tickPeriod;
        ...
        onRender: function (chart) {
            if (this._container) {
                ...
                var handleMouse = function (isActive) {
                    return function () {
                        d3_selection__WEBPACK_IMPORTED_MODULE_1__["select"](this)
                            .classed({
                            active: isActive,
                ...
                var canv = d3_selection__WEBPACK_IMPORTED_MODULE_1__["select"](chart.getSVG());
...
taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.plugins.add('trendline', trendline);
