...
/******/ 	return __webpack_require__(__webpack_require__.s = "./plugins/floating-axes.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./plugins/floating-axes.js":
/*!**********************************!*\
  !*** ./plugins/floating-axes.js ***!
  \**********************************/
...
var d3 = __assign({}, d3_selection__WEBPACK_IMPORTED_MODULE_1__);
...
function floatingAxes(_settings) {
    ...
    return {
        ...
        createFloatingLayout: function () {
            ...
            var scrollbars = taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.globalSettings.getScrollbarSize(root);
            ...
            d3Svg.selectAll('.floating-axes')
                ...
                d3_selection__WEBPACK_IMPORTED_MODULE_1__["event"].stopPropagation();
            })
                .on('click', function () {
                d3_selection__WEBPACK_IMPORTED_MODULE_1__["event"].stopPropagation();
            });
...
taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.plugins.add('floating-axes', floatingAxes);
/* harmony default export */ __webpack_exports__["default"] = (floatingAxes);
