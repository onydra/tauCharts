...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("d3-array"), require("taucharts"));
	else if(typeof define === 'function' && define.amd)
		define(["d3-array", ], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("d3-array"), require("taucharts")) : factory(root["d3"], root["Taucharts"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(window, function(__WEBPACK_EXTERNAL_MODULE_d3_array__, __WEBPACK_EXTERNAL_MODULE_taucharts__) {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./plugins/layers.js");
/******/ })
/************************************************************************/
/******/ ({
    ...
    return {
        ...
        onUnitsStructureExpanded: function () {
            ...
            if (self._isApplicable && (settings.mode === 'merge')) {
                ...
                var minMax = d3_array__WEBPACK_IMPORTED_MODULE_1__["extent"](utils.flatten(Object.keys(hashBounds)
                    .map(function (key) {
...
taucharts__WEBPACK_IMPORTED_MODULE_0___default.a.api.plugins.add('layers', Layers);
// jscs:enable *
